...
// v30: optional Kernel configuration on the native Run; NULL preserves native behavior.
// v31: preserve the first approved plan's default Run attempt ceiling across configuration changes.
// v32: Kernel acceptance is separate from worker-writable native results.
